...
<html lang="en">
  ...
  <body>
    <div class="container" style="margin-left:90px;">
      ...
      <form action="USNselect1stsemprinci.php" method="post" enctype="multipart/form-data">
    ...
    <button type="submit" class="btn btn-orange" name="submit">Search</button>
      ...
      <div class="form-group">
       <table class="table table-bordered table-hover table-dark">
        ...
        $sql="SELECT * FROM `batch20151stsem` WHERE `USN`='$id'"; 
...
$data=mysqli_fetch_assoc($run)?> 
  ...
  <tbody>
    <tr>
      ...
      <th scope="row">15MAT11</th>
        <th scope="row">15PHY12</th>
        <th scope="row">15CIV13</th>
        <th scope="row">15EME14</th>
        <th scope="row">15ELE15</th>
        <th scope="row">15WSL16</th>
        <th scope="row">15PHYL17</th>
        <th scope="row">15CIP18</th>
        ...
        {   $count=0;
            while($data=mysqli_fetch_assoc($run))
            {
                ...
                <tr>
                      ...
                      <th scope="row"><?php echo $data['15MAT11GL'];?></th>
                      <th scope="row"><?php echo $data['15PHY12GL'];?></th>
                      <th scope="row"><?php echo $data['15CIV13GL'];?></th>
                      <th scope="row"><?php echo $data['15EME14GL'];?></th>
                      <th scope="row"><?php echo $data['15ELE15GL'];?></th>
                      <th scope="row"><?php echo $data['15WSL16GL'];?></th>
                      <th scope="row"><?php echo $data['15PHYL17GL'];?></th>
                      <th scope="row"><?php echo $data['15CIP18GL'];?></th>
        ...
        {   $count=0;
            while($data=mysqli_fetch_assoc($run))
            {
                ...
                <tr>
                      ...
                      <th scope="row"><?php echo $data['USN'];?></th>
                      <th scope="row"><?php echo $data['Name'];?></th>
                      <th scope="row"><?php echo $data['15MAT11GP'];?></th>
                      <th scope="row"><?php echo $data['15PHY12GP'];?></th>
                      <th scope="row"><?php echo $data['15CIV13GP'];?></th>
                      <th scope="row"><?php echo $data['15EME14GP'];?></th>
                      <th scope="row"><?php echo $data['15ELE15GP'];?></th>
                      <th scope="row"><?php echo $data['15WSL16GP'];?></th>
                      <th scope="row"><?php echo $data['15PHYL17GP'];?></th>
                      <th scope="row"><?php echo $data['15CIP18GP'];?></th>
                      <th scope="row"><?php echo $data['TCredits'];?></th>
                      <th scope="row"><?php echo $data['SGPA'];?></th>
                </tr>
                <?php   
