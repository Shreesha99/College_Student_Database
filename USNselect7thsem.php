...
<html lang="en">
  ...
  <body>
    <div class="container" style="margin-left:90px;">
      ...
      <form action="USNselect7thsem.php" method="post" enctype="multipart/form-data">
...
if(($data['15CS71T'] && $data['15IS72T'] && $data['15CS743T'] && $data['15IS753T'] && $data['15CSL76T'] && $data['15CSL77T'] && $data['15ISP78T'])  >= 40)
        {
