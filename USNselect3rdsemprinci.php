...
<html lang="en">
  ...
  <body>
    <div class="container" style="margin-left:90px;">
      ...
      <form action="USNselect3rdsemprinci.php" method="post" enctype="multipart/form-data">
    ...
    <button type="submit" class="btn btn-orange" name="submit">Search</button>
      ...
      <div class="form-group">
       <table class="table table-bordered table-hover table-dark">
        ...
        $sql="SELECT * FROM `batch20153rdsem` WHERE `USN`='$id'"; 
...
$data=mysqli_fetch_assoc($run)?> 
  ...
  <tbody>
    <tr>
      ...
      <th scope="row">15MAT31</th>
        <th scope="row">15CS32</th>
        <th scope="row">15CS33</th>
        <th scope="row">15CS34</th>
        <th scope="row">15CS35</th>
        <th scope="row">15CS36</th>
        <th scope="row">15CSL37</th>
        <th scope="row">15CSL38</th>
        ...
        {   $count=0;
            while($data=mysqli_fetch_assoc($run))
            {
                ...
                <tr>
                      ...
                      <th scope="row"><?php echo $data['15MAT31GL'];?></th>
                      <th scope="row"><?php echo $data['15CS32GL'];?></th>
                      <th scope="row"><?php echo $data['15CS33GL'];?></th>
                      <th scope="row"><?php echo $data['15CS34GL'];?></th>
                      <th scope="row"><?php echo $data['15CS35GL'];?></th>
                      <th scope="row"><?php echo $data['15CS36GL'];?></th>
                      <th scope="row"><?php echo $data['15CSL37GL'];?></th>
                      <th scope="row"><?php echo $data['15CSL38GL'];?></th>
        ...
        {   $count=0;
            while($data=mysqli_fetch_assoc($run))
            {
                ...
                <tr>
                      ...
                      <th scope="row"><?php echo $data['USN'];?></th>
                      <th scope="row"><?php echo $data['Name'];?></th>
                      <th scope="row"><?php echo $data['15MAT31GP'];?></th>
                      <th scope="row"><?php echo $data['15CS32GP'];?></th>
                      <th scope="row"><?php echo $data['15CS33GP'];?></th>
                      <th scope="row"><?php echo $data['15CS34GP'];?></th>
                      <th scope="row"><?php echo $data['15CS35GP'];?></th>
                      <th scope="row"><?php echo $data['15CS36GP'];?></th>
                      <th scope="row"><?php echo $data['15CSL37GP'];?></th>
                      <th scope="row"><?php echo $data['15CSL38GP'];?></th>
                      <th scope="row"><?php echo $data['TCredits'];?></th>
                </tr>
                <?php   
